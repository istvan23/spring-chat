    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                .authorizeHttpRequests((authorize) -> authorize
                        ...
                        .permitAll()
                        .antMatchers(HttpMethod.POST, "/api/user/registration")
                        .permitAll()
                        .anyRequest().authenticated()
                )
                .cors().and().csrf().disable()//.csrf((csrf) -> csrf.ignoringAntMatchers("/api/auth/login").ignoringAntMatchers("/api/user/registration"))
